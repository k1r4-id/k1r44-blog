...
draft: false
summary: >-
  Password attack cheatsheet covering remote attacks, Windows and Linux local attacks, and password cracking
---
...
| `hashcat -m 22100 backup.hash /opt/useful/seclists/Passwords/Leaked-Databases/rockyou.txt -o backup.cracked` | Uses Hashcat to crack the extracted BitLocker hashes using a wordlist and outputs the cracked |
